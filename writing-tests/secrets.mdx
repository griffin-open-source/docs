---
title: "Secrets"
description: "Keep sensitive values out of your test files"
---

Use `secret()` to reference sensitive values like API keys and tokens in your tests. Secrets are resolved at runtime by the executor — the actual values never appear in your test files or monitor definitions stored in the hub.
...
- **Never hardcode secrets** in test files — always use `secret()`
