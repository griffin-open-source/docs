---
title: "Introduction"
description: "Open-source API testing platform for production monitoring"
---

## What is Griffin?

Griffin is an open-source platform for writing API tests in TypeScript and running them continuously against your production APIs. Write tests as code, deploy them to a hub, and get notified when things break.
...
<CardGroup cols={2}>
  ...
  >
    Write tests using sequential or graph-based builders with full type safety and IDE autocomplete.
  </Card>
  <Card
  ...
  >
    Schedule tests to run every minute, hour, or day. Track success rates, latency, and uptime.
  </Card>
  <Card
  ...
  >
    Run tests from multiple regions to catch geographic issues.
  </Card>
  <Card
    title="Notifications"
    icon="bell"
