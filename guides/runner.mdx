...
Resolve sensitive values at runtime using the runner's secret providers:

- Environment variables for local development
- AWS Secrets Manager for production on AWS
- HashiCorp Vault for centralized enterprise secrets

Keep secrets out of test plans and repositories.
